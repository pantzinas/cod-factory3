...
public class ExceptionTypes {
     ...
     * Since a checked exception is thrown, it
     * has to be explicitly thrown in method signature.
     * Or has to be caught {}
     ...
     * in method signature. And the exception not propagate.
     * Is it a good practice, not to propagate?
     * It depends. If there is a caller, then we have to propagate.
     * If there is a client/user, there we do not propagate the
     * exception.
     * @return
     */
     ...
     * action -- logging, and also we rethrow the exception to
